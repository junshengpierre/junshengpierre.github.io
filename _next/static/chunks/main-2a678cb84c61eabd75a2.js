  ...
  [4],
  {
    ...
    IKlv: function (e, t, n) {
      ...
      var m = p(n('q1tI')),
        ...
        A = p(n('bGXG')),
        C = n('nOHt'),
        x = JSON.parse(document.getElementById('__NEXT_DATA__').textContent)
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 23:
                      if (
                        ((e.prev = 23),
                        (e.t0 = e.catch(10)),
                        !(R.INITIAL_CSS_LOAD_ERROR in e.t0))
                      ) {
                        e.next = 27
                        break
                      }
                    ...
                    case 32:
                      return (
                        (t.router = J = (0, C.createRouter)(I, L, G, {
                          initialProps: k,
                          pageLoader: W,
                          App: Q,
                          Component: z,
          ...
          W.loadPage('/_error').then(function (r) {
            var a = r.page,
              ...
              c = {
                ...
                AppTree: i,
                router: J,
                ctx: { err: n, pathname: I, query: L, asPath: G, AppTree: i },
              }
            return Promise.resolve(
              e.props ? e.props : (0, b.loadGetInitialProps)(t, c)
            ).then(function (t) {
              return he(
                (0, h.default)({}, e, {
                  err: n,
      ...
      function de(e) {
        ...
        return m.default.createElement(
          ...
          {
            fn: function (e) {
              return ce({ App: Q, err: e }).catch(function (e) {
      ...
      var pe = function (e) {
        return function (t) {
          var n = (0, h.default)({}, t, { Component: z, err: N, router: J })
          return m.default.createElement(
            de,
            null,
      ...
      var r,
        ...
        S = function (e) {
          var t,
            ...
            u = c('largest-contentful-paint', o)
          if (u) {
            t = p(e, r, u, n)
            var s = function () {
              r.isFinal || (u.takeRecords().map(o), (r.isFinal = !0), t())
            }
            y().then(s), d(s, !0)
          }
        },
            ...
            },
            {
              ...
              value: function (e, t, n, r) {
                var a = this,
                  ...
                  g = v ? (0, s.interpolateAs)(i, p, c).result : ''
                return v ? g && m(g) : m(h)
              },
            },
            {
              ...
              value: function (e, t, n) {
                var r = this,
                  a = S((0, d.parseRelativeUrl)(e).pathname)
                              ...
                              switch ((n.prev = n.next)) {
                                ...
                                case 3:
                                  ;(i = n.sent),
                                    ...
                                    (o.pageCache[e] = c),
                                    o.pageRegisterEvents.emit(e, c),
                                    (n.next = 13)
                                  break
                                case 9:
                                  ;(n.prev = 9),
                                    (n.t0 = n.catch(0)),
                                    (o.pageCache[e] = { error: n.t0 }),
                ...
                ;('/_app' === e
                  ...
                  : (c
                      ...
                      return Promise.all(
                        ...
                        throw (c && Object.defineProperty(e, v, {}), e)
                      })
                    })
                ).then(
                  function (e) {
